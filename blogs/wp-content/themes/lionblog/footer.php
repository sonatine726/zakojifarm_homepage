    ...
    <div class="container">
      ...
      <?php endif; ?>
	    ...
	    <span class="copyright__info<?php if (get_option('fit_theme_copyrightInfo')): ?> u-none<?php endif; ?>">
		  <?php bloginfo( 'name' ); ?> by <a class="copyright__link" href="http://fit-jp.com/" target="_blank">FIT</a>. Powered by <a class="copyright__link" href="https://wordpress.org/" target="_blank">WordPress</a>.
        </span>
