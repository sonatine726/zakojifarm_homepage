    ...
    <div class="l-hMain">
      <div class="container">
	    ...
	    ?>
          ...
          <?php if($myAmp){echo '<amp-img layout="responsive"';}else{echo '<img';} ?> src="<?php echo $logo;?>" alt="<?php bloginfo('name') ?>" width="<?php echo $logo_width;?>" height="<?php echo $logo_height;?>" ><?php if($myAmp){echo '</amp-img>';}?>	
