...
const hanyu_1_dict = { fieldId:"hanyu_1", 
                    ...
                    url:"ricefields/rf_hanyu_1.html",
                    zoom: 18,
                    block: "岩間周辺",
                    number: 4,
                    address: "3223-1",
...
$(function(){
  ...
  if($("td.p-rfc-prop-block")[0]){
    $("td.p-rfc-prop-block").text(hanyu_1_dict.block);
  }
  if($("td.p-rfc-prop-number")[0]){
    $("td.p-rfc-prop-number").text(hanyu_1_dict.number);
  };
  if($("td.p-rfc-prop-fieldName")[0]){
    $("td.p-rfc-prop-fieldName").text(hanyu_1_dict.fieldName);
  }
  if($("td.p-rfc-prop-address")[0]){
    $("td.p-rfc-prop-address").text(hanyu_1_dict.address);
  }
  if($("td.p-rfc-prop-area")[0]){
    $("td.p-rfc-prop-area").text(hanyu_1_dict.area + "a");
  }
