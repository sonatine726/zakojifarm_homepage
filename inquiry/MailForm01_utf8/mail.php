...
$site_top = "https://zakojifarm.jp/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "info@zakojifarm.jp";
...
$refrom_name = "お米の座光寺農園";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "座光寺農園へのお問い合わせ、ありがとうございました。";
...
座光寺農園へのお問い合わせ、ありがとうございました。
内容を確認の上回答いたしますので、お待ちいただければと思います。
...
.p-mailform__button:hover {
  background: #fffbef;
}
</style>
<section class="p-confirm-sct">
<?php if($empty_flag == 1){ ?>
<div align="center">
...
<?php }else{ ?>
  <div class="p-confirm-sct__dev">
    <h1>確認画面</h1>
    <p align>以下の内容で間違いがなければ、「送信」ボタンを押してください。</p>
    <form action="/inquiry/MailForm01_utf8/mail.php" method="POST">
      <table class="p-confirm-table">
<?php echo confirmOutput($_POST);//入力内容を表示?>
      </table>
    <p align="center"><input type="hidden" name="mail_set" value="confirm_submit">
      <input type="hidden" name="httpReferer" value="https://zakojifarm.jp/inquiry/inquiry.html">
      <input type="submit" value="　送信　" class="p-mailform__button">
      <input type="button" value="前画面に戻る" onClick="history.back()" class="p-mailform__button">
    </p>
    </form>
  </div>
<?php } ?>
